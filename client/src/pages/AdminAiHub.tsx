          ...
          <div className="space-y-3.5">
            <div className="w-full bg-white/40 dark:bg-black/40 backdrop-blur-md border border-white/20 dark:border-white/10 rounded-outer p-5 shadow-sm space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full h-12 rounded-[18px] px-4 text-xs font-bold focus:outline-none focus:ring-1 focus:ring-[#CCFF00] bg-white/60 dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 text-black dark:text-white"
                >
            ...
            {generatedResult && (
              <div className="w-full bg-white/40 dark:bg-black/40 backdrop-blur-md border border-white/20 dark:border-white/10 rounded-outer p-5 shadow-sm space-y-3">
                ...
                <div className="p-4 rounded-[18px] bg-white/60 dark:bg-zinc-900/90 border border-slate-200 dark:border-zinc-800 text-xs leading-relaxed whitespace-pre-line font-medium">
                  {generatedResult}
                </div>
              </div>
            )}
        ...
        {activeSlide === 1 && (
          <div className="space-y-3.5">
            <div className="w-full bg-white/40 dark:bg-black/40 backdrop-blur-md border border-white/20 dark:border-white/10 rounded-outer p-5 shadow-sm space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  <h4 className="font-bold text-sm">Главный автопилот</h4>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <span className="text-xs font-semibold">Дожим новых лидов до пробного</span>
                  <input 
                    type="checkbox" 
                ...
                <div className="flex items-center justify-between">
                  <span className="text-xs font-semibold">Ответы на частые вопросы (FAQ)</span>
                  <input 
                    type="checkbox" 
                ...
                <div className="grid grid-cols-3 gap-2">
                  {[
                    ...
                    <button
                      ...
                      className={`h-10 rounded-[14px] text-xs font-bold transition-all border cursor-pointer ${
                        toneOfVoice === t.id 
                          ? 'bg-[#CCFF00] text-black border-[#CCFF00]' 
                          : 'bg-black/5 dark:bg-zinc-900 border-zinc-800 text-zinc-400'
                      }`}
                    >
                      {t.label}
                    </button>
            ...
            <div className="w-full bg-white/40 dark:bg-black/40 backdrop-blur-md border border-white/20 dark:border-white/10 rounded-outer p-5 shadow-sm space-y-4">
              <div>
                ...
                <textarea
                  ...
                  className="w-full rounded-[16px] p-3 text-xs font-medium bg-white/60 dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 resize-none focus:outline-none focus:ring-1 focus:ring-[#CCFF00]"
                />
              </div>
              ...
              <button
                ...
                style={{ backgroundColor: accentColor || '#CCFF00', color: '#000000' }}
                className="w-full h-12 font-black text-xs uppercase tracking-wider rounded-full flex items-center justify-center gap-2 shadow-md hover:brightness-105 transition-all cursor-pointer border-none"
              >
                <Save size={16} />
                Сохранить настройки
              </button>
